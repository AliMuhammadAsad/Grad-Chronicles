...
SIGMA = repmat(diag([0.0001; 0.0001; 0.0001]), 1,N);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%555
...
prevTime = 1;
it = 0;
while rate.TotalElapsedTime < 2000
    ...
    [particles, SIGMA] = mclIncrementalLocalization(particles, SIGMA, u, Q, [theta'; rho'], M, params, sqrt(10), params.WHEEL_SEP);
% MCL_incrementalLocalization(particles, SIGMA_seq, u, Q, S, M, params, g, b)
    waitfor(rate);
    it = it + 1;
    disp("Time")
